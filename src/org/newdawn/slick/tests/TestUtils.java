...
public class TestUtils {
	...
	public void init() {
		...
		try {
			texture = TextureLoader.getTexture(TextureLoader.PNG, new FileInputStream("testdata/rocks.png"));
		...
		try {
			...
			// a sound
			oggEffect = AudioLoader.getAudio(AudioLoader.OGG, new FileInputStream("testdata/restart.ogg"));
			...
			oggStream = AudioLoader.getStreamingAudio(AudioLoader.OGG, new File("testdata/bongos.ogg").toURL());
			...
			modStream = AudioLoader.getStreamingAudio(AudioLoader.MOD, new File("testdata/SMB-X.XM").toURL());
			
			// you can play aifs by loading the complete thing into 
			// a sound
			aifEffect = AudioLoader.getAudio(AudioLoader.AIF, new FileInputStream("testdata/burp.aif"));

			// you can play wavs by loading the complete thing into 
			// a sound
			wavEffect = AudioLoader.getAudio(AudioLoader.WAV, new FileInputStream("testdata/cbrown01.wav"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
