...
/**
 * The central provider that maps real device input into abstract commands defined by the developer. Registering
 * a control against an command with this class will cause the provider to produce an event for the command
 * when the input is pressed and released.
 * 
 * @author joverton
 */
public class InputProvider {  
    ...
    /**
     * Add a listener to the provider. This listener will be notified 
     * of commands detected from the input.
     * 
    ...
    /**
     * Remove a listener from this provider. The listener will no longer 
     * be provided with notification of commands performe.
     * 
    ...
    /**
     * Check if the last control event we recieved related to the
     * given command indicated that a control was down
     * 
    ...
    /**
     * Check if one of the controls related to the command specified
     * has been pressed since we last called this method
     * 
     * @param command The command to check
    ...
    /**
     * Fire notification to any interested listeners that a control
     * has been pressed indication an particular command
     * 
    ...
    /**
     * Fire notification to any interested listeners that a control
     * has been released indication an particular command should be stopped
     * 
     * @param command The command that has been pressed
     */
    ...
    /**
     * A token representing the state of all the controls causing an command
     * to be invoked
     * 
     * @author kevin
     */
    private class CommandState {
    	...
    	/**
    	 * Check if a control for the command has been pressed since
    	 * last call.
    	 * 
    	...
    	/**
    	 * Check if the last event we had indicated the control 
    	 * was pressed
    	 * 
