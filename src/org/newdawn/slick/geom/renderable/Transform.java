...
public class Transform {
    ...
    public Transform concatenate(Transform transform) {
        return new Transform(
                matrixPosition[0] * transform.matrixPosition[0], matrixPosition[1] * transform.matrixPosition[1], 
                matrixPosition[2] * transform.matrixPosition[2], matrixPosition[3] * transform.matrixPosition[3], 
                matrixPosition[4] * transform.matrixPosition[4], matrixPosition[5] * transform.matrixPosition[5]);
    }
